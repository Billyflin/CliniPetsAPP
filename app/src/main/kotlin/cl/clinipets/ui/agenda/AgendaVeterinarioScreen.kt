...
fun AgendaVeterinarioScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text("Mis Agendas (Veterinario)") },
                navigationIcon = {
            ...
            LazyColumn(
                ...
                item {
                    Row(
                        ...
                        Text("Mis agendas como veterinario", style = MaterialTheme.typography.titleMedium)
...
@Composable
private fun FiltrosPanelVeterinario(
